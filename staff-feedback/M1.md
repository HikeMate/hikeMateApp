...
The product backlog should be refined and should contain more user stories.
The user stories you have do not follow the proper format. They should be structured as 'As a [user], I want to [goal] so that [reason].' Please ensure that all user stories are written in this format to clearly define the user, their goal, and the benefit. Also, make sure to add an 'epic' tag so we can distiguish between the different user stories you added.
...
Based on the above points, your intermediate grade for this milestone M1 is 5.12. If you are interested in how this fits into the bigger grading scheme, please see [project README](https://github.com/swent-epfl/private/blob/main/project/README.md) and the [course README](https://github.com/swent-epfl/public/blob/main/README.md).
