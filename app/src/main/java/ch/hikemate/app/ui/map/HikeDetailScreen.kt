...
fun HikeDetailScreen(
    ...
    var facilities: List<Facility>? by remember { mutableStateOf(null) }
    ...
    mapView.addMapListener(object : MapListener {
        override fun onScroll(event: ScrollEvent): Boolean {
            facilitiesViewModel.getFacilities(mapView.boundingBox.toBounds(),
                { facilities = it },
                {})
            return true
        }
            ...
            Column(
                ...
                Row {
                    ...
                    Image(
                        painter = painterResource(
                            hikeDetailState?.bookmark ?: R.drawable.bookmark_no_fill
                        ),
                        contentDescription =
                ...
                val hourString =
                    String.format(
                        Locale.getDefault(),
                        "%02d",
                        (detailedRoute.estimatedTime / 60).toInt()
                    )
                val minuteString =
                    String.format(
