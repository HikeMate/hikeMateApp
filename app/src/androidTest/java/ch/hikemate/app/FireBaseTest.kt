    ...
    fun testFirebaseReadAndWrite() {
        ...
        db.collection("testCollection")
            ...
            .addOnSuccessListener { documentReference ->
                assertTrue(true)
                Log.d("FireBaseTest", "DocumentSnapshot added with ID: " +
        ...
        db.collection("testCollection")
            ...
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    assertTrue("Read from Firebase failed. Got error: " +
                            "${task.exception}", false)
                }
                latchGet.countDown()
            }
                    ...
                    for (document in task.result!!) {
                        db.collection("testCollection")
                            ...
                            .addOnSuccessListener {
                                assertTrue("Delete from Firebase worked. Deleted document: " +
                                        document.id, true)
